...
def get_parser():
    ...
    arg_parser.add_argument("fpath", type=lambda x: Path(x), help="filename of text file or path to files", nargs='*')
    ...
    arg_parser.add_argument('--threshwindow', type=int, default=31, help='Size of the window (binarization): %(default)s')
